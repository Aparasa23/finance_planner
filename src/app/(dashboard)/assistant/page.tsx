...
export default function AssistantPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      sender: 'assistant',
      text: "Hello! I am your **Finance OS Assistant**. I can help you summarize accounts, review upcoming bills, track savings targets, or run spending analytics for your household. What would you like to explore today?",
    },
  ])
