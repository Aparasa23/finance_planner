      ...
      <div className="w-full max-w-md space-y-8 glass-panel p-8 rounded-3xl border border-gray-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Initialize your private household node</p>
          </div>
        </div>
        ...
        <div className="text-center pt-2">
          <p className="text-xs text-gray-500">
            ...
            <Link href="/login" className="font-semibold text-emerald-400 hover:text-emerald-300 transition-all">
              Sign In
            </Link>
          </p>
        </div>
